...
python hyperwords/text2numpy.py $OUTPUT_DIR/sgns.words $OUTPUT_DIR/sgns.words
python hyperwords/text2numpy.py $OUTPUT_DIR/sgns.contexts $OUTPUT_DIR/sgns.contexts
